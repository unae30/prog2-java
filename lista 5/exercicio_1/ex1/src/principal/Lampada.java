...
public class Lampada {
	...
	public Lampada() {
		...
		System.out.println("O total de lâmpadas criadas é: " + Lampada.ContadorInstancias);
	...
	public void Luminosidade(int luminosidade) {
		if(this.estaLigada == true) {
			...
			System.out.println("Não é possível alterar a luminosidade pois a lampada esta desligada.");
		}
	}
	...
	public void quantasVezesFoiLigada() {
		System.out.println("A lâmpada foi ligada " + contadorLigada + "x .");
	}	
