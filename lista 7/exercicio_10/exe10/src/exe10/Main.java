		...
		switch(aux) {
			case 1: 
				try {
					...
					System.out.println("o resultado da divisão é: " + calculadora.div(numero1, numero2));
			...
			case 2:
				try {
					...
					System.out.println("o resultado do Log de " + numero + " na base 10 é: " + calculadora.log10(numero));
